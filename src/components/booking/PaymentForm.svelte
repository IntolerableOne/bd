    ...
    <div class="bg-white p-6 rounded-lg shadow-sm border">
      <div class="flex items-center justify-between mb-6">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6" viewBox="0 0 32 21">
          ...
          <path d="M13.2 6.15h-2c-.11 0-.2.09-.2.2v4.7c0 .11.09.2.2.2h2c.11 0 .2-.09.2-.2v-4.7c0-.11-.09-.2-.2-.2zm4.4 0h-2c-.11 0-.2.09-.2.2v4.7c0 .11.09.2.2.2h2c.11 0 .2-.09.2-.2v-4.7c0-.11-.09-.2-.2-.2zm4.4 0h-2c-.11 0-.2.09-.2.2v4.7c0 .11.09.2.2.2h2c.11 0 .2-.09.2-.2v-4.7c0-.11-.09-.2-.2-.2z" fill="#FFF"/>
        </svg>
      </div>
